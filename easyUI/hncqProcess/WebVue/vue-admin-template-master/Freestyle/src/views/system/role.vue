<template>
  <div class="p20">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" :before-close="clearRole">
      <el-form ref="formSet" :model="formSet">
    ...
    <el-dialog :title="dialogTreeTitle" :visible.sync="dialogSxlbVisible" class="dialogBox">
      <!--zreet -->
      <div class="shu">
        <el-tree ref="tree" :data="shuData" :default-checked-keys="shuMo" :props="defaultProps" show-checkbox default-expand-all node-key="id" check-strictly="true" highlight-current/>
      </div>
      <div slot="footer" class="dialog-footer">
