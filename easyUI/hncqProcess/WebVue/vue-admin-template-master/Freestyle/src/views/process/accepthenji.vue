<template>
    <div class="acceptzh">
        ...
        <el-table :data="tableData" border style="width: 100%" height="70vh">
            ...
            <el-table-column prop="projectCode" label="划分编码">
            </el-table-column>
            ...
            <el-table-column prop="checkDescribe" label="说明">
            </el-table-column>
...
export default {
    ...
    methods:{
        ...
        // 查询接口
        chaxun(){
            request.post('/rest/processCheck/searchHenJi',{orgId:this.orgId}).then((res)=>{
