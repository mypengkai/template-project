  ...
  <div class="commandCheck elInputBox">
    <el-form :model="form" label-width="150px">
      <el-form-item label="工程分部分项：">
        <el-input type="textarea" style="width:30vw" :autosize="{ minRows: 2, maxRows: 4}" v-model="form.projectItem"
                  readonly></el-input>
      </el-form-item>
      <div style="width:50%">
      ...
      <el-form-item label="巡视描述：">
        <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}" v-model="form.describe" style="width:30vw"
                  readonly></el-input>
      </el-form-item>
    </el-form>
    <div class="content">
