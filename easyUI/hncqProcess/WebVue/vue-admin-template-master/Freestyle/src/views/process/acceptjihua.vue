<template>
    <div class="acceptzh">
        <el-row>
            ...
            <el-col :span="6">
                姓名：<el-input v-model="form.userName" placeholder="请输入内容" style="width:50%"></el-input>
            </el-col>
            <el-col :span="6">
            验收类型：<el-select v-model="value" placeholder="请选择">
                <el-option
        ...
        <el-row>
            <el-col :span="6">
            工序状态：<el-select v-model="value1" placeholder="请选择">
                <el-option
        ...
        <el-table :data="tableData" border style="width: 100%;margin-top:20px" height="62vh" v-if="tableData.length!=0">
         ...
         <!-- 分页 -->
        <div class="block" style="padding-left:15px" id="blockTop" v-if="tableData.length!=0">
        <el-pagination
            ...
            request.post('/rest/processCheck/searchCheakDeatil',formData).then((res)=>{
                if(res.data.respCode=='0'){
                    ...
                    this.tableData.forEach(i=>{
                        ...
                        //     i.planCheckTime=''
                        // }
                        i.state=="0"?i.state="指定工序":i.state="已指定验收计划"
                    })
