  ...
  <div class="printerCheck">
    <div class="printerCheckTop">
      <span>
        <el-form label-width="80px" :inline="true">
          <el-form-item label="验收编码:">
            <el-input v-model="form.processNumber" placeholder="请输入验收编码"></el-input>
          </el-form-item>
        </el-form>
      </span>
      <span>
    ...
    <div class="printCheckConent" v-if="isShow">
      ...
      <el-table :data="tableData" style="width: 100%" max-height="600" border>
        ...
        <el-table-column prop="processNumber" label="验收编码" width="120"></el-table-column>
