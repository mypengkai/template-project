...
<template>
  <div class="p20">
    ...
    <el-table border :data="smsLogList" style="width: 100%" height="67vh" class="textList">
      <el-table-column prop="userName" label="用户名称" align="center" width="150px"/>
      <el-table-column prop="sendPhone" label="手机号码" align="center" width="200px"/>
      <el-table-column prop="smsDate" label="发送时间" align="center" width="200px"/>
      <el-table-column prop="smsContent" label="发送内容" align="left"/>
      <el-table-column prop="sendNum" label="发送数量" align="center" width="100px"/>
    </el-table>
    <!-- 分页 -->
    <el-pagination :page-sizes="[7,15,20,30]" :page-size="1" :total="total" :current-page.sync="smsLog.pageNo"
