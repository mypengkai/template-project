      ...
      <el-form ref="rechargeForm" :model="rechargeForm" label-width="120px" :rules="rules">
        ...
        <el-col :span="8">
          <el-form-item label="发送成功:" prop="sendSmsSuccessNum">
            <el-input v-model.number="rechargeForm.sendSmsSuccessNum" :readonly="true" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
    ...
    saveRecharge(){   //保存
      ...
      this.$refs['rechargeForm'].validate((valid) => {
        ...
        if (valid) {
          ...
          smsRechargeAPI.saveOrUpdateSmsRecharge(that.rechargeForm).then(res => {
            this.$message({
              type: "success",
