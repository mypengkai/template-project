  ...
  <div class="p20">
    ...
    <div class="processtable">
      <el-table :data="tableData" height="50vh" stripe border highlight-current-row>
        ...
        <el-table-column min-width="150px" prop="createTime" label="创建时间"/>
...
export default {
  ...
  methods: {
    initTable() {
      return request.post('/rest/process/getList',
    ...
    deleteProcess(processId) {
      this.$confirm('确定删除该工序?', '提示', {
        ...
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => request.get(`/rest/process/delete/${processId}`).then((res) => {
