  ...
  <div class="informLayout">
    ...
    <div class="informList">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column fixed prop="date" label="发送时间"></el-table-column>
        <el-table-column prop="province" label="发起人"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作">
            <template slot-scope="scope">
                ...
                <el-button type="danger" size="small" icon="el-icon-delete" @click="open7(scope.row)" circle></el-button>
            </template>
        </el-table-column>
      </el-table>
        ...
        <div class="microLayout">
          ...
          <div class="userList">
            ...
            >
              ...
              <el-table-column prop="duty" label="地址" show-overflow-tooltip></el-table-column>
            </el-table>
          </div>
