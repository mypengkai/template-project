<template>
  <div class="p20">
    ...
    <!-- 数据列表 -->
    <el-table :data="tableData" :row-style="{height: '0'}" class="textList" height="68vh" stripe highlight-current-row border>
      ...
      <el-table-column min-width="150px" fixed="right" label="操作" align="center">
        <template slot-scope="scope">
          <el-tooltip class="item" effect="dark" content="修改" placement="top">
            <el-button v-ltx="'processingUpdate'" type="warning" size="small" icon="el-icon-edit" circle @click="editProcess(scope.row)"/>
          </el-tooltip>
    ...
    <el-pagination :current-page="queryParamData.pageNo" :page-sizes="[10,20,30]" :page-size="queryParamData.pageSize" :total="total" class="pageList pt20 mt1" background
                   layout="total, sizes, prev, pager, next, jumper" @size-change="handleSizeChange" @current-change="initTable"/>
