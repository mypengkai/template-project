<template>
    <div class="imgez">
        <el-table :data="chakanData"  border>
            <el-row>
            <el-col :span="5"><el-table-column property="projectCode" label="代码"></el-table-column></el-col>
        ...
        <el-row>
            <el-col :span="12"><div class="zj">自检资料</div></el-col>
            <el-col :span="12"><div class="ys">验收资料</div></el-col>
        </el-row>
        <el-table :data="chakanData"  border>
        ...
        <el-row>
            <el-col :span="12"><div class="zjm">自检描述: <span>{{zijian}}</span></div></el-col>
        ...
        <el-form :model="imgForm" label-width="200px">
            ...
            <el-form-item label="图片说明:">
                <el-input v-model="imgForm.photoDescribe"></el-input>
            </el-form-item>
            <el-form-item label="纬度:">
                <el-input v-model="imgForm.lgt"></el-input>
            </el-form-item>
            <el-form-item label="经度:">
                <el-input v-model="imgForm.lat"></el-input>
            </el-form-item>
            </div> 
