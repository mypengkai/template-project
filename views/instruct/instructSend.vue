  ...
  <div class="p20">
    ...
    <div>
      <el-table class="textList" :data="getList" style="width: 100%" height="59vh">
        ...
        <el-table-column prop="commandUserNow" label="完成人" width="100px" align="center"></el-table-column>
        <!-- <el-table-column prop="createTime" label="发起时间">
        </el-table-column>-->

        <el-table-column prop="planTime" label="创建时间" width="200px" align="center"></el-table-column>

        <el-table-column prop="commandType1" label="指令类型" width="100px"></el-table-column>

        <el-table-column prop="issolve1" label="能否处理" width="100px" align="center"></el-table-column>

        <el-table-column prop="status1" label="状态" width="100px" align="center"></el-table-column>
